...
#ifdef  ARCH_64
static erts_atomic64_t
    last_ref[(ERTS_CACHE_LINE_SIZE) / sizeof(erts_atomic64_t)]
...
{
#ifdef  ARCH_64
    Uint64 val = erts_atomic64_inc_read_mb(last_ref);
...
{
#ifdef  ARCH_64
    erts_atomic64_init_nob(last_ref, 0);
#else   /* ARCH_32 */
    reference0 = 0;
    reference1 = 0;
    reference2 = 0;
