...
/* this type exists only to force the compiler to use it as an intermediate */
#ifndef HAVE_INT128
#ifdef  ERTS_INT128_TYPE
#define HAVE_INT128 1
typedef unsigned ERTS_INT128_TYPE Uint128;
typedef ERTS_INT128_TYPE          Sint128;
#elif   SIZEOF_LONG_LONG == 16
#define HAVE_INT128 1
typedef unsigned long long  Uint128;
typedef long long           Sint128;
#elif   SIZEOF___INT128 == 16
#define HAVE_INT128 1
typedef unsigned __int128 Uint128;
typedef __int128          Sint128;
#elif   SIZEOF___INT128_T == 16
#define HAVE_INT128 1
