...
|:-----|:---|:-----|:----------|:---------|
| Active       | OTP-18 | [`basho-otp-18`](http://github.com/basho/otp/tree/basho-otp-18) | _n/a_ | [`OTP-18.3.2`](http://github.com/basho/otp/tree/OTP-18.3.2) |
...
Unless you want to suggest a patch to our specific Erlang/OTP changes, if you find something you think needs to be changed you'll want to refer to the Erlang [instructions for submitting patches][otp_patching].
...
Everything in Erlang/OTP, whether part of the original distribution or a contribution of ours, is subject to the terms of the [Apache License, Version 2.0][license].
  ...
  [otp_patching]: http://wiki.github.com/erlang/otp/submitting-patches
