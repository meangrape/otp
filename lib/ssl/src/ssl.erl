...
handle_options(Opts0) ->
    ...
    SSLOptions = #ssl_options{
        ...
        secure_renegotiate = handle_option(
            secure_renegotiate, Opts, ?DEFAULT_SECURE_RENEGOTIATE),
        ...
        honor_cipher_order = handle_option(
            honor_cipher_order, Opts, ?DEFAULT_HONOR_CIPHER_ORDER),
        protocol = proplists:get_value(protocol, Opts, tls),
        padding_check =  proplists:get_value(
            padding_check, Opts, ?DEFAULT_PADDING_CHECK),
